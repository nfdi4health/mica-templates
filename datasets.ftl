...
<p>After selecting an instrument, a brief description is provided along a graphical overview on targeted areas. &nbsp;When selecting &ldquo;Questionnaire items&rdquo;, a searchable list of items appears.</p>
        </div>
